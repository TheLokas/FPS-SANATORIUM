                    ...
                    vbox:
                        ...
                        imagebutton:
                            if preferences.fullscreen:
                                idle "images/settings/yes.png"
                                #hover "images/settings/no.png"
                            else:
                                idle "images/settings/no.png"
                                #hover "images/settings/yes.png"
                            # idle "images/settings/no.png"
                            # selected "images/settings/yes.png"
                            # selected_idle "images/settings/yes.png"
                            #hover "images/settings/yes.png"
                            #clicked "images/settings/yes.png"
                            #selected preferences.fullscreen
                            action If (preferences.fullscreen, Preference("display", "window"), Preference("display", "fullscreen"))

                        #textbutton _("Оконный") action If (preferences.fullscreen, Preference("display", "window"), Preference("display", "fullscreen"))
